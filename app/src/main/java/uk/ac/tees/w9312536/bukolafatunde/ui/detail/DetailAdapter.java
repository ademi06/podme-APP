...
import uk.ac.tees.w9312536.bukolafatunde.databinding.DetailListItemBinding;
import uk.ac.tees.w9312536.bukolafatunde.model.rss.Item;
import uk.ac.tees.w9312536.bukolafatunde.utilities.PodCastUtils;

import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.IMG_HTML_TAG;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.REPLACEMENT_EMPTY;
...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.DetailViewHolder> {
    ...
    public class DetailViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bind(Item item) {
            ...
            String itemImageUrl = PodCastUtils.getItemImageUrl(item, mPodcastImage);
