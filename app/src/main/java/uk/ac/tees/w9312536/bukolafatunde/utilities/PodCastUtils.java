...
public class PodCastUtils {
    ...
    public static String getFormattedDateString(String pubDate) {
        SimpleDateFormat simpleDateFormat =
                new SimpleDateFormat(Constants.PUB_DATE_PATTERN, Locale.US);
        ...
        SimpleDateFormat formatter = new SimpleDateFormat(Constants.FORMATTED_PATTERN, Locale.US);
    ...
    private static String getFormattedDateStringFromGmt(String pubDate) {
        SimpleDateFormat simpleDateFormat =
                new SimpleDateFormat(Constants.PUB_DATE_PATTERN_TIME_ZONE, Locale.US);
        Date currentTime = null;
        try {
            currentTime = simpleDateFormat.parse(pubDate);
        } catch (ParseException e) {
