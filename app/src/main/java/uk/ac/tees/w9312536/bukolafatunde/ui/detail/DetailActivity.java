...
import uk.ac.tees.w9312536.bukolafatunde.databinding.ActivityDetailBinding;
...
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.ACTION_RELEASE_OLD_PLAYER;
...
public class DetailActivity extends AppCompatActivity
    ...
    public void onItemClick(Item item, ImageView imageView) {
        ...
        PodCastUtils.updateSharedPreference(this, item, mResultName,
                PodCastUtils.getItemImageUrl(item, mPodcastImage));
        // Send an update broadcast message to the app widget
        PodCastUtils.sendBroadcastToWidget(this);
