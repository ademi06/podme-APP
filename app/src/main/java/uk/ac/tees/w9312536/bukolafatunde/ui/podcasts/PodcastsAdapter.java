...
import uk.ac.tees.w9312536.bukolafatunde.databinding.PodcastsListItemBinding;

import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.DELETE;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.GROUP_ID_DELETE;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.ORDER_DELETE;
...
public class PodcastsAdapter extends RecyclerView.Adapter<PodcastsAdapter.PodcastsViewHolder> {
    ...
    public class PodcastsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        private void delete(final PodcastEntry podcastEntry) {
            ...
            final PodMeDatabase db = PodMeDatabase.getInstance(mContext);
