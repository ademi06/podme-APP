...
import uk.ac.tees.w9312536.bukolafatunde.model.rss.Enclosure;
...
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.NO_DRAWABLES;
    ...
    private void setDrawable() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            mDownloadsBinding.tvEmptyDownloads.setCompoundDrawablesRelativeWithIntrinsicBounds(
                    NO_DRAWABLES, R.drawable.ic_menu_download, NO_DRAWABLES, NO_DRAWABLES);
        } else {
