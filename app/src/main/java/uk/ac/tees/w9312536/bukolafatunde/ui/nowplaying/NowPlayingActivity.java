...
import uk.ac.tees.w9312536.bukolafatunde.AppExecutors;
import uk.ac.tees.w9312536.bukolafatunde.R;
import uk.ac.tees.w9312536.bukolafatunde.analytics.Analytics;
import uk.ac.tees.w9312536.bukolafatunde.data.DownloadEntry;
import uk.ac.tees.w9312536.bukolafatunde.data.FavoriteEntry;
import uk.ac.tees.w9312536.bukolafatunde.data.PodMeDatabase;
import uk.ac.tees.w9312536.bukolafatunde.databinding.ActivityNowPlayingBinding;
import uk.ac.tees.w9312536.bukolafatunde.model.rss.Item;
import uk.ac.tees.w9312536.bukolafatunde.service.PodcastDownloadService;
import uk.ac.tees.w9312536.bukolafatunde.service.PodcastService;
import uk.ac.tees.w9312536.bukolafatunde.utilities.DownloadUtil;
...
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.BLUR_RADIUS;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.BLUR_SAMPLING;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.EXTRA_DOWNLOAD_ENTRY;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.EXTRA_ITEM;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.EXTRA_PODCAST_IMAGE;
...
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.FORMAT_ELAPSED_TIME;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.PROGRESS_UPDATE_INITIAL_INTERVAL;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.PROGRESS_UPDATE_INTERVAL;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.SHARE_INTENT_TYPE_TEXT;
import static uk.ac.tees.w9312536.bukolafatunde.utilities.Constants.TYPE_AUDIO;
...
//        });
    ...
    private void setupUI() {
        ...
        mItemImageUrl = PodCastUtils.getItemImageUrl(mItem, mPodcastImage);
    ...
    private void changeFavIcon(boolean isFavorite, Menu menu) {
        if (isFavorite) {
            menu.findItem(R.id.action_favorite).setIcon(R.drawable.ic_baseline_favorite);
        } else {
            menu.findItem(R.id.action_favorite).setIcon(R.drawable.ic_baseline_favorite_border);
        }
    }
